<#
.SYNOPSIS
    Create an atom.xml file for a NuGet feed that offers pre-release versions of the Sarifer.
.DESCRIPTION
    To make versions of the Sarifer available to a limited audience before they are published to the
    Marketplace (https://marketplace.visualstudio.com/items?itemName=WDGIS.MicrosoftSarif),
...
$vsixId = "Microsoft.Sarif.Sarifer.Michael C. Fanning.f17e897a-fd38-4e1f-99db-19fa34a4e184";
$version = Get-Version;
...
<feed xmlns="http://www.w3.org/2005/Atom">
    ...
    <entry>
        <id>$vsixId</id>
        <title type="text">Sarifer VSIX for Visual Studio $VsVersion</title>
