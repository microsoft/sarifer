...
function Uninstall-SarifExtension {
    Write-Host "Uninstalling Microsoft Sarifer"
    Start-Process -Wait -FilePath VSIXInstaller.exe -ArgumentList "/quiet", "/force", '/uninstall:"Microsoft.Sarif.Sarifer.Michael C. Fanning.f17e897a-fd38-4e1f-99db-19fa34a4e184"'
